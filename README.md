...
문제 상황 : 
- 멋쟁이사자처럼 AIS7 수업이 줌(Zoom) 화상 프로그램을 활용한 쌍방향 온라인 수업으로 진행되었습니다. 70명 이상의 참가자들이 온라인 학습 과정에서 불편함을 겪지 않도록 출석 관리, 자리 비움 확인, 수업에 방해가 될 수 있는 움직임 감지 등 실시간으로 관리하는 모니터링 매니저님의 노고를 알게 되었습니다.
- 모니터링 매니저님 혼자서 다수의 줌 화면을 확인하는 데는 높은 집중도와 에너지가 소모된다고 판단하였고, 적은 인력으로도 다수의 참가자를 세밀하게 관리하는 방법을 고민하게 되었습니다.
